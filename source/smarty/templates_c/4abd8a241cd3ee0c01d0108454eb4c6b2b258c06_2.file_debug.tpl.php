<?php
/* Smarty version 5.5.1, created on 2025-06-03 09:02:15
  from 'file:/www/htdocs/w00a13e2/ffw_verein/libs/smarty/src/debug.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_683e9df79d9941_33562190',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4abd8a241cd3ee0c01d0108454eb4c6b2b258c06' => 
    array (
      0 => '/www/htdocs/w00a13e2/ffw_verein/libs/smarty/src/debug.tpl',
      1 => 1748872931,
      2 => 'file',
    ),
  ),
...
function content_683e9df79d9941_33562190 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/www/htdocs/w00a13e2/ffw_verein/libs/smarty/src';
$_smarty_tpl->getSmarty()->getRuntime('Capture')->open($_smarty_tpl, '_smarty_debug', 'debug_output', null);?>
 ...
 Debug Console
        -  <?php if ((true && ($_smarty_tpl->hasVariable('template_name') && null !== ($_smarty_tpl->getValue('template_name') ?? null)))) {
echo $_smarty_tpl->getSmarty()->getModifierCallback('debug_print_var')($_smarty_tpl->getValue('template_name'));?>
 <?php }
if (!( !$_smarty_tpl->hasVariable('template_data') || empty($_smarty_tpl->getValue('template_data')))) {?>Total Time <?php echo htmlspecialchars((string) (sprintf("%.5f",$_smarty_tpl->getValue('execution_time'))), ENT_QUOTES, 'UTF-8');
}?></h1>

    <?php if (!( !$_smarty_tpl->hasVariable('template_data') || empty($_smarty_tpl->getValue('template_data')))) {?>
...
?>
            <tr>
                <td>
                    ...
                    <?php if ((true && (true && null !== ($_smarty_tpl->getValue('vars')['nocache'] ?? null)))) {?><strong>Nocache</strong><br><?php }?>
                    <?php if ((true && (true && null !== ($_smarty_tpl->getValue('vars')['scope'] ?? null)))) {?><strong>Origin:</strong> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('debug_print_var')($_smarty_tpl->getValue('vars')['scope']);
}?>
                </td>
                <td>
                    <h3>Value</h3>
                ...
                <td>
                    <?php if ((true && (true && null !== ($_smarty_tpl->getValue('vars')['attributes'] ?? null)))) {?>
                        <h3>Attributes</h3>
