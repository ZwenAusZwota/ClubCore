<main class="content">
	...
	<ul id="tabs" class="nav nav-tabs" role="tablist">
		...
		<li class="nav-item">
			<a id="tabs_nav_plugins" class="nav-link" href="{$mainURL}/settings/plugins" data-toggle="tab" role="tab">Plugins</a>
		</li>
		<li class="nav-item">
			<a id="tabs_nav_managers" class="nav-link active" href="{$mainURL}/settings/managers" data-toggle="tab" role="tab">Vorstand</a>
		</li>
	</ul>
